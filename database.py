...
async def init_db():
    async with aiosqlite.connect(DB_PATH) as db:
        ...
        if count == 0:
            logging.info("🌱 Database empty. Seeding initial categories and items for Mogosu...")
            ...
            await db.commit()
            logging.info("✅ Database seeded with 9 emoji categories and all items for Mogosu.")
